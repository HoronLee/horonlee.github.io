...
<template>
  ...
  >
    <!-- 自定义页脚内容 -->
    <a href="https://icp.gov.moe/?keyword=20241146" target="_blank"
      >萌ICP备20241146号</a
    >
    ...
    <div style="display: flex">
      <a
        ...
        ><img
          src="https://sourcebucket.s3.bitiful.net/badge/Hosted-Vercel-brightgreen.svg"
      ...
      <a
        ...
        style="margin-inline: 5px"
        title="本网站源码由Github提供存储仓库"
        ><img
          src="https://sourcebucket.s3.bitiful.net/badge/Source-Github-d021d6.svg"
          data-lazy-src="https://sourcebucket.s3.bitiful.net/badge/Source-Github-d021d6.svg"
          alt=""
          data-ll-status="loaded"
          class="entered loaded"
      /></a>
