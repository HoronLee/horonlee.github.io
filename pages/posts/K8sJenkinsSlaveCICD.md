...
![image-20240521165104748](https://qiniu.oss.horonlee.com/img/image-20240521165104748.png)
...
对于卷，我们使用“本地”存储类进行演示。 这意味着，它会在“/mnt”位置下的特定节点中创建一个“PersistentVolume”卷。
...
![image-20240520171133771](https://qiniu.oss.horonlee.com/img/image-20240520171133771.png)

![image-20240520203918154](https://qiniu.oss.horonlee.com/img/image-20240520203918154.png)

![image-20240520172053933](https://qiniu.oss.horonlee.com/img/image-20240520172053933.png)

设置全局安全设置为任何用户可以做任何事

![image-20240521091337373](https://qiniu.oss.horonlee.com/img/image-20240521091337373.png)
...
![image-20240524113108010](https://qiniu.oss.horonlee.com/img/image-20240524113108010.png)
...
![image-20240524113145423](https://qiniu.oss.horonlee.com/img/image-20240524113145423.png)

![](https://qiniu.oss.horonlee.com/img/image-20240524113155274.png)
...
![image-20240524110717223](https://qiniu.oss.horonlee.com/img/image-20240524110717223.png)
...
![image-20240524110730512](https://qiniu.oss.horonlee.com/img/image-20240524110730512.png)

然后翻动页面到下方，找到`Run As User ID`和`Run As Group ID`，填入`0`，目的是让 Pod 中的容器可以正常执行 docker 和 ctr 命令。（0 是宿主机 root 用户的组 ID）

![image-20240524110742021](https://qiniu.oss.horonlee.com/img/image-20240524110742021.png)
...
![image-20240524111443286](https://qiniu.oss.horonlee.com/img/image-20240524111443286.png)
...
![image-20240523211247452](https://qiniu.oss.horonlee.com/img/image-20240523211247452.png)

构建完成后，访问 http://172.30.26.172:30080就可以看到博客正常被测试发布了，临时的 jenkins-slave pod 也被自动删除了

![image-20240524111844969](https://qiniu.oss.horonlee.com/img/image-20240524111844969.png)
...
![image-20240522171022271](https://qiniu.oss.horonlee.com/img/image-20240522171022271.png)
