...
`),i(`span`,{class:`line`},[i(`span`,null,`[config/images] Pulled registry.k8s.io/coredns/coredns:v1.10.1`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[2]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubeadm init --kubernetes-version=v1.27.0 --pod-network-cidr=10.224.0.0/16 --apiserver-advertise-address=192.168.1.200`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`        --discovery-token-ca-cert-hash sha256:7adc6b2a7551f204371d38c6a6da34d7deb321fda863b54bfe2b4d9b1811f680`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[3]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-worker ~]# kubeadm join 192.168.1.200:6443 --token ux83mg.qlhot371w5rtub2u \\`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`Run 'kubectl get nodes' on the control-plane to see this node join the cluster.`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[4]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get node # 这里是因为需要管理权限的环境变量才可以执行管理命令，这一点和OpenStack十分相似`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`k8s-worker   NotReady   <none>          48s     v1.27.0`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[5]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`vim /etc/containerd/config.toml`)]),r(`
`),i(`span`,{class:`line`},[i(`span`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`未更改：sandbox_image = "registry.aliyuncs.com/google_containers/pause:3.6"`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[6]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl apply -f calico.yaml`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`deployment.apps/calico-kube-controllers created`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[7]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get pod -n kube-system`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`kube-scheduler-k8s-master                  1/1     Running    0          16m`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[8]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl apply -f dashboard.yaml`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`deployment.apps/dashboard-metrics-scraper created`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[9]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get pod -n kubernetes-dashboard -o wide`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`kubernetes-dashboard-6967859bff-nrtsl        0/1     ImagePullBackOff   0          26s   10.224.254.133   k8s-worker   <none>           <none>`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[10]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get svc -n kubernetes-dashboard`)]),r(`
...
`),i(`span`,{class:`line`},[i(`span`,null,`kubernetes-dashboard        ClusterIP   10.103.7.49     <none>        443/TCP    2m6s`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[11]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl edit svc kubernetes-dashboard -n kubernetes-dashboard`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`service/kubernetes-dashboard edited # 将ClusterIP 改为NodePort`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[12]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get svc -n kubernetes-dashboard`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`NAME                        TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)         AGE`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`dashboard-metrics-scraper   ClusterIP   10.106.18.213   <none>        8000/TCP        3m40s`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`kubernetes-dashboard        NodePort    10.103.7.49     <none>        443:30571/TCP   3m41s`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[13]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl apply -f dashboard-user.yaml`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`serviceaccount/admin-user created`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`clusterrolebinding.rbac.authorization.k8s.io/admin-user created`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[14]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl -n kubernetes-dashboard create token admin-user`)]),r(`
`),i(`span`,{class:`line`},[i(`span`,null,`eyJhbGciOiJSUzI1NiIsImtpZCI6InVCZUlsckJGWUZoMTJfRDA2eVFsMm85d3lEYml4WmQxV2RmNGtNWGlzZUEifQ..BOa9nhIPfx_qWoQOn8hbfA70Y2fIeO_xcjK5wJJdrgS2yeSFIqD07LwHyw6eT9a03leNUaSA6gj3kYeAQnbCpw8pacdGJAaBBL-Y6Y31p4uVNSH9bs9TJuVAGyfKzJ4G8eyj3bZ11PlEtLNXeCr7bB_tO_8Z93lCK-F8h9VfQV5TGxCRAmjWXX3c1tpox236lIVsDA8UC8LqrWO4TW5p22om5ES9RsgVypoYQPwZ0O7hy9k_7mMe2Nh2hdiibhuezwGcm2fl_fgBsK9REaer0NZF420p1crxUBiE0LfxfvgTTGHAnbwWlw_M2pFehvx82Lx6jmduNnq-0cPcReb4cw`)])])]),i(`button`,{class:`code-block-unfold-btn`})],-1),s[15]||=i(`p`,null,`访问Web页面相关问题，Web页面的端口是随机的，需要手动查看容器状态，可以看到下面dashboard映射出来的端口是30571`,-1),s[16]||=i(`div`,{class:`language-`},[i(`button`,{title:`Copy code`,class:`copy`}),i(`span`,{class:`lang`}),i(`pre`,{class:`shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code`},[i(`code`,{"v-pre":``},[i(`span`,{class:`line`},[i(`span`,null,`[root@k8s-master ~]# kubectl get svc -A -o wide`)]),r(`
